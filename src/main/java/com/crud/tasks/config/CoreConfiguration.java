...
//This is configuring SWAGGER documentation API and everything else, hence name CORE CONFIGURATION
@EnableScheduling //For automatic mail sending with time intervals
@EnableSwagger2 //For documentation API
@Configuration
...
//        }
    ...
    //This sets spaces spring can scan and give to app user
    @Override
